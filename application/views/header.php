      ...
      <div class="sidebar-inner">
        ...
        <ul class="sidebar-menu scrollable pos-r">
          <li class="nav-item mT-30 active">
            <a class="sidebar-link" href="index.html"><span class="icon-holder"><i class="c-orange-500 ti-layout-list-thumb"></i> </span><span class="title">Jadwal Harian</span></a>
          </li>
          <li class="nav-item">
            <a class="sidebar-link" href="kalender"><span class="icon-holder"><i class="c-blue-500 ti-calendar"></i> </span><span class="title">Kalender</span></a>
          </li>
          <?php if (isset($ceks)) :
            if ($level == 'superadmin') : ?>
              <li class="nav-item">
          ...
          <?php if (isset($ceks)) : ?>
            <li class="nav-item">
              ...
              <a class="sidebar-link" href="laporan"><span class="icon-holder"><i class="c-brown-500 ti-book"></i> </span><span class="title">Laporan</span></a>
            </li>
          <?php endif; ?>
          <?php //if (isset($ceks)) : 
          ?>
          <li class="nav-item">
            <!--pada href tersebut yang 'laporan' merupakan nama controller-->
            <a class="sidebar-link" href="bahan_berita"><span class="icon-holder"><i class="c-red-500 ti-write"></i> </span><span class="title">Bahan Berita</span></a>
          </li>
          <?php //endif; 
          ?>
        </ul>
            ...
            <?php else : ?>
              <li class="dropdown">
                ...
                <ul class="dropdown-menu fsz-sm">
                  <li>
                    <a href="profile.html" class="d-b td-n pY-5 bgcH-grey-100 c-grey-700"><i class="ti-user mR-10"></i> <span>Profile</span></a>
                  </li>
